...
export const produceList = [
    ...
    { id: "ssrrinami_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "sense", osusume: "concentration", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrsaki_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "sense", osusume: "goodcondition", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.5 },
    {
    ...
    { id: "ssrchina_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "logic", osusume: "motivation", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrsumika_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "sense", osusume: "concentration", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrmao_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "sense", osusume: "goodcondition", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrkotone_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "anomaly", osusume: "fullpower", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.5 },
    {
    ...
    { id: "ssrlilja_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "logic", osusume: "goodimpression", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrhiro_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "logic", osusume: "motivation", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    {
    ...
    { id: "ssrtsubame_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "logic", osusume: "motivation", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.4 },
    ...
    { id: "ssrume_1st14another", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "logic", osusume: "goodimpression", category: "live", source: "limited", releasedAt: "2026-08-16", another: true, jumpTime2: 7.5 },
    {
    ...
    {
        id: "ssrtemari_summer2limited", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", osusume: "enthusiasm", rarity: "PSSR", plan: "anomaly", source: "limited", category: "gravia", jumpTime2: 9.1, releasedAt: "2026-08-17", youtube_url: "https://youtu.be/ebTsJRw7e0c?si=5flzzHh-cGgEQhNd",
        item: {
            name: "夏を編んだ影",
    ...
    {
        id: "ssrsena_summer2dist", name: "저기, 말해버릴까.", name_ja: "ねえ、言っちゃうよ。", rarity: "PSSR", plan: "sense", osusume: "concentration", source: "dist", category: "gravia", jumpTime2: 7.4, releasedAt: "2026-08-17", youtube_url: "https://youtu.be/ebTsJRw7e0c?si=5flzzHh-cGgEQhNd",
        item: {
            name: "溶けてゆく夏",
            desc: "3턴 마다 \n✦ genki3\n✦ concentration2\n✦ inlesson2",
            desc_ja: "3ターンごとに\n✦ genki3\n✦ concentration2\n✦ inlesson2",

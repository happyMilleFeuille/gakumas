...
export const produceList = [
    ...
    // --- 사키 SSR (PSSR) ---
    { id: "ssrsaki_1st", name: "Fighting My Way", osusume: "goodcondition", rarity: "PSSR", plan: "sense", source: "normal", releasedAt: "2024-05-16", youtube_url: "https://youtu.be/T1GK55fsIhw?si=co4Dg0YTDqRSh5hQ" },
    ...
    // --- 코토네 SSR (PSSR) ---
    { id: "ssrkotone_1st", name: "세계에서 제일 귀여운 나", osusume: "goodimpression", name_ja: "世界一可愛い私", rarity: "PSSR", plan: "logic", source: "normal", jumpTime2: 5.3, releasedAt: "2024-05-16", youtube_url: "https://youtu.be/cHaEJgn4HYc?si=b6kiMK7AwkQuMJB1" },
    ...
    // --- 히로 SSR (PSSR) ---
    { id: "ssrhiro_1st", name: "광경", name_ja: "光景", osusume: "motivation", rarity: "PSSR", plan: "logic", source: "normal", jumpTime2: 10.3, releasedAt: "2024-05-16", youtube_url: "https://youtu.be/VJk2etK8I1w?si=OA8K2zri7qLpp5l2" },
    ...
    { id: "ssrrinami_summerlimited", name: "너와 세미블루", name_ja: "キミトセミブルー", osusume: "goodcondition", releasedAt: "2024-07-12", rarity: "PSSR", plan: "sense", source: "limited", jumpTime2: 10.4, youtube_url: "https://youtu.be/Z-LWjF5J6Mw?si=iDZ_xMAwUs5PeSz6" },
    { id: "ssrsumika_summerlimited", name: "너와 세미블루", name_ja: "キミトセミブルー", osusume: "motivation", releasedAt: "2024-07-01", rarity: "PSSR", plan: "logic", source: "limited", youtube_url: "https://youtu.be/Z-LWjF5J6Mw?si=iDZ_xMAwUs5PeSz6" },
    { id: "ssrsaki_kanmuridist", name: "관국", name_ja: "冠菊", osusume: "goodimpression", releasedAt: "2024-08-01", rarity: "PSSR", plan: "logic", source: "dist", youtube_url: "https://youtu.be/E8G7BMd2a7g?si=4Q4zuYDOCt5A0pK4" },
    { id: "ssrkotone_kanmurilimited", name: "관국", name_ja: "冠菊", osusume: "motivation", releasedAt: "2024-08-11", rarity: "PSSR", plan: "logic", source: "limited", youtube_url: "https://youtu.be/E8G7BMd2a7g?si=4Q4zuYDOCt5A0pK4" },
    { id: "ssrlilja_kanmurilimited", name: "관국", name_ja: "冠菊", osusume: "goodcondition", rarity: "PSSR", releasedAt: "2024-08-01", plan: "sense", source: "limited", jumpTime2: 9.3, youtube_url: "https://youtu.be/E8G7BMd2a7g?si=4Q4zuYDOCt5A0pK4" },
    { id: "ssrchina_halloweendist", name: "가장광소곡", name_ja: "仮装狂騒曲", osusume: "concentration", releasedAt: "2024-09-30", rarity: "PSSR", plan: "sense", source: "dist", youtube_url: "https://youtu.be/8YNzp2vRS9I?si=iI19xe6asn2wlShB" },
    { id: "ssrtemari_halloweenlimited", name: "가장광소곡", name_ja: "仮装狂騒曲", osusume: "motivation", releasedAt: "2024-09-30", rarity: "PSSR", plan: "logic", source: "limited", youtube_url: "https://youtu.be/8YNzp2vRS9I?si=iI19xe6asn2wlShB" },
    { id: "ssrhiro_halloweenlimited", name: "가장광소곡", name_ja: "仮装狂騒曲", osusume: "goodcondition", rarity: "PSSR", releasedAt: "2024-10-08", plan: "sense", source: "limited", youtube_url: "https://youtu.be/8YNzp2vRS9I?si=iI19xe6asn2wlShB" },
    ...
    { id: "ssrume_christmaslimited", name: "White Night! White Wish!", osusume: "goodcondition", rarity: "PSSR", plan: "sense", source: "limited", releasedAt: "2024-11-28", youtube_url: "https://youtu.be/MXWTuX-QC00?si=9SLS_nXFeHS0nAl_" },
    { id: "ssrlilja_christmaslimited", name: "White Night! White Wish!", osusume: "motivation", rarity: "PSSR", releasedAt: "2024-12-09", plan: "logic", source: "limited", youtube_url: "https://youtu.be/MXWTuX-QC00?si=9SLS_nXFeHS0nAl_" },
    { id: "ssrhiro_valentinedist", name: "해피 밀푀유", osusume: "fullpower", name_ja: "ハッピーミルフィーユ", releasedAt: "2025-02-01", rarity: "PSSR", plan: "anomaly", source: "dist", youtube_url: "https://youtu.be/AON5aAVG3QU?si=jjjTsAYWxnD3L_Wd" },
    { id: "ssrrinami_valentinelimited", name: "해피 밀푀유", osusume: "enthusiasm", name_ja: "ハッピーミルフィーユ", releasedAt: "2025-02-01", rarity: "PSSR", plan: "anomaly", source: "limited", jumpTime2: 9.3, youtube_url: "https://youtu.be/AON5aAVG3QU?si=jjjTsAYWxnD3L_Wd" },
    { id: "ssrsena_valentinelimited", name: "해피 밀푀유", osusume: "motivation", name_ja: "ハッピーミルフィーユ", releasedAt: "2025-02-14", rarity: "PSSR", plan: "logic", source: "limited", jumpTime2: 9.8, youtube_url: "https://youtu.be/AON5aAVG3QU?si=jjjTsAYWxnD3L_Wd" },
    { id: "ssrtemari_yukidokenidist", name: "눈녹을 쯤에", osusume: "enthusiasm", name_ja: "雪解けに", rarity: "PSSR", releasedAt: "2025-02-28", plan: "logic", source: "dist", youtube_url: "https://youtu.be/ZnUy-qYDhAo?si=6Awhdq0VlneX_z9s" },
    ...
    { id: "ssrmao_yukidokenilimited", name: "눈녹을 쯤에", osusume: "fullpower", name_ja: "雪解けに", rarity: "PSSR", releasedAt: "2025-03-10", plan: "anomaly", source: "limited", youtube_url: "https://youtu.be/ZnUy-qYDhAo?si=6Awhdq0VlneX_z9s" },
    ...
    { id: "ssrsumika_miracledist", name: "미라클 나나우(˚∀˚)!", name_ja: "ミラクルナナウ(˚∀˚)!", osusume: "goodimpression", releasedAt: "2025-08-29", rarity: "PSSR", plan: "logic", source: "dist", youtube_url: "https://youtu.be/dp-x87l413o?si=Hv_16Q1XBERH5SNg" },
    { id: "ssrmao_miraclelimited", name: "미라클 나나우(˚∀˚)!", name_ja: "ミラクルナナウ(˚∀˚)!", osusume: "motivation", releasedAt: "2025-08-29", rarity: "PSSR", plan: "logic", source: "limited", jumpTime2: 9.2, youtube_url: "https://youtu.be/dp-x87l413o?si=Hv_16Q1XBERH5SNg" },
    { id: "ssrhiro_miraclelimited", name: "미라클 나나우(˚∀˚)!", name_ja: "ミラクルナナウ(˚∀˚)!", osusume: "fullpower", rarity: "PSSR", releasedAt: "2025-09-08", plan: "anomaly", source: "limited", youtube_url: "https://youtu.be/dp-x87l413o?si=Hv_16Q1XBERH5SNg" },
    { id: "ssrsaki_gamusyaradist", name: "닥치는 대로 가자!", name_ja: "がむしゃらに行こう！", osusume: "enthusiasm", releasedAt: "2025-09-29", rarity: "PSSR", plan: "anomaly", source: "dist", youtube_url: "https://youtu.be/RVazZ92UGL8?si=3CuzdLdv9TMvOY5H" },
    { id: "ssrkotone_gamusyaralimited", name: "닥치는 대로 가자!", name_ja: "がむしゃらに行こう！", osusume: "goodcondition", releasedAt: "2025-09-29", rarity: "PSSR", plan: "sense", source: "limited", youtube_url: "https://youtu.be/RVazZ92UGL8?si=3CuzdLdv9TMvOY5H" },
    { id: "ssrtemari_gamusyaralimited", name: "닥치는 대로 가자!", name_ja: "がむしゃらに行こう！", osusume: "goodimpression", releasedAt: "2025-10-10", rarity: "PSSR", plan: "logic", source: "limited", youtube_url: "https://youtu.be/RVazZ92UGL8?si=3CuzdLdv9TMvOY5H" },
    ...
    { id: "ssrsaki_ameagariunit", name: "비 갠 뒤의 아이리스", name_ja: "雨上がりのアイリス", osusume: "motivation", rarity: "PSSR", releasedAt: "2025-05-01", plan: "logic", source: "limited_u", jumpTime2: 10.1, youtube_url: "https://youtu.be/SPXHpau0jJI?si=oODrMuHOaMtcjNzu" },
    { id: "ssrtemari_ameagariunit", name: "비 갠 뒤의 아이리스", name_ja: "雨上がりのアイリス", osusume: "goodcondition", rarity: "PSSR", releasedAt: "2025-05-01", plan: "sense", source: "limited_u", jumpTime2: 10.2, youtube_url: "https://youtu.be/SPXHpau0jJI?si=oODrMuHOaMtcjNzu" },
    { id: "ssrkotone_ameagariunit", name: "비 갠 뒤의 아이리스", name_ja: "雨上がりのアイリス", osusume: "enthusiasm", rarity: "PSSR", releasedAt: "2025-05-01", plan: "anomaly", source: "limited_u", jumpTime2: 9.4, youtube_url: "https://youtu.be/SPXHpau0jJI?si=oODrMuHOaMtcjNzu" },
    { id: "ssrchina_michinaruunit", name: "미지로 펼쳐지는", name_ja: "みちなるひろがる", osusume: "concentration", releasedAt: "2026-01-27", rarity: "PSSR", plan: "sense", source: "limited_u", jumpTime2: 8.2, youtube_url: "https://youtu.be/qwfpgEhngVI?si=VRd8V2lIVDiOGYgO" },
    { id: "ssrhiro_michinaruunit", name: "미지로 펼쳐지는", name_ja: "みちなるひろがる", osusume: "goodimpression", releasedAt: "2026-01-27", rarity: "PSSR", plan: "logic", source: "limited_u", jumpTime2: 8.3, youtube_url: "https://youtu.be/qwfpgEhngVI?si=VRd8V2lIVDiOGYgO" },
    { id: "ssrlilja_dokimekiunit", name: "두근두근 이모션", name_ja: "どきめきエモーション", osusume: "goodcondition", releasedAt: "2026-04-01", rarity: "PSSR", plan: "sense", source: "limited_u", jumpTime2: 8.3, youtube_url: "https://youtu.be/QulHtowM_6o?si=Benh9o2SxRGcRtG-" },
    { id: "ssrsumika_dokimekiunit", name: "두근두근 이모션", name_ja: "どきめきエモーション", osusume: "enthusiasm", releasedAt: "2026-04-01", rarity: "PSSR", plan: "anomaly", source: "limited_u", jumpTime2: 8.3, youtube_url: "https://youtu.be/QulHtowM_6o?si=Benh9o2SxRGcRtG-" },


    // --- PSR (Produce SR) ---
    { id: "srrinami_1sr", name: "『나다움』의 시작", name_ja: "『私らしさ』のはじまり", osusume: "concentration", rarity: "PSR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "srchina_1sr", name: "가슴을 펴고 한걸음씩", name_ja: "胸を張って一歩ずつ", osusume: "motivation", rarity: "PSR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    ...
    { id: "srkotone_1sr", name: "귀여움♡시작했어요", name_ja: "カワイイ♡はじめました", osusume: "goodimpression", rarity: "PSR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    { id: "srtemari_1sr", name: "한마리의 늑대", name_ja: "一匹狼", osusume: "concentration", rarity: "PSR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "srsaki_1sr", name: "내가 1번!", name_ja: "わたしが一番!", osusume: "goodcondition", rarity: "PSR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },


    // --- PR (Produce R) ---
    { id: "rrinami_1r", name: "학원생활", name_ja: "学園生活", osusume: "concentration", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "rrinami_2r", name: "초심", name_ja: "初心", osusume: "motivation", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-09-07" },
    { id: "rchina_1r", name: "학원생활", name_ja: "学園生活", osusume: "motivation", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    { id: "rchina_2r", name: "초심", name_ja: "初心", osusume: "goodcondition", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-09-07" },
    { id: "rtsubame_1r", name: "학원생활", name_ja: "学園生活", osusume: "enthusiasm", rarity: "PR", plan: "anomaly", source: "normal", releasedAt: "2025-11-16" },
    { id: "rsena_1r", name: "학원생활", name_ja: "学園生活", osusume: "enthusiasm", rarity: "PR", plan: "anomaly", source: "normal", releasedAt: "2024-11-16" },
    ...
    { id: "rtemari_1r", name: "학원생활", name_ja: "学園生活", osusume: "concentration", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "rtemari_2r", name: "초성", name_ja: "初声", osusume: "goodimpression", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-08-10" },
    { id: "rkotone_1r", name: "학원생활", name_ja: "学園生活", osusume: "goodimpression", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    { id: "rkotone_2r", name: "초성", name_ja: "初声", osusume: "goodcondition", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-08-10" },
    { id: "rmao_1r", name: "학원생활", name_ja: "学園生活", osusume: "goodcondition", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "rmao_2r", name: "초변", name_ja: "初恋", osusume: "goodimpression", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-10-14" },
    { id: "rlilja_1r", name: "학원생활", name_ja: "学園生活", osusume: "goodimpression", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    { id: "rlilja_2r", name: "초심", name_ja: "初心", osusume: "goodcondition", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-09-07" },
    { id: "rsumika_1r", name: "학원생활", name_ja: "学園生活", osusume: "concentration", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-05-16" },
    { id: "rsumika_2r", name: "초변", name_ja: "初恋", osusume: "motivation", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-10-14" },
    { id: "rhiro_1r", name: "학원생활", name_ja: "学園生活", osusume: "motivation", rarity: "PR", plan: "logic", source: "normal", releasedAt: "2024-05-16" },
    { id: "rhiro_2r", name: "초변", name_ja: "初恋", osusume: "concentration", rarity: "PR", plan: "sense", source: "normal", releasedAt: "2024-10-14" },

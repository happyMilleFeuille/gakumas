...
export const cardList = [
    ...
    },
    {
        ...
        plan: "logic",
        have: "item",
        item_effects: [{ type: "action", trigger: ["get_motivation"], stats: { vocal: 30 }, targettext: ["hp5"], max: 2 }],
    ...
    },
    {
        ...
        type: "dance",
        have: "item",
        item_effects: [{ type: "action", trigger: ["class"], target: "change", stats: { dance: 10 }, max: 2 }],
